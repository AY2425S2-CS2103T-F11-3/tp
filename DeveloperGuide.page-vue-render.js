...
with(this){return _c('ul',[_c('li',[_v("Should work on any mainstream OS as long as it has "),_c('strong',[_v("Java 17 or above")]),_v(" installed.")]),_v(" "),_c('li',[_v("Should be able to handle up to "),_c('strong',[_v("50 concurrent patients")]),_v(" without noticeable sluggishness in performance for typical use.")]),_v(" "),_c('li',[_v("A user with "),_c('strong',[_v("above-average typing speed")]),_v(" for regular English text (i.e., not code or system admin commands) should be able to accomplish most tasks "),_c('strong',[_v("faster using commands than with the mouse")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("HealthSync must comply with relevant healthcare data protection regulations")]),_v(", such as "),_c('strong',[_v("PDPA")]),_v(".")]),_v(" "),_c('li',[_v("The architecture should support "),_c('strong',[_v("modular extensions")]),_v(", allowing for additional features (e.g., appointment scheduling, integration with electronic health records).")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 17:27:16 GMT+8]")])])])}
}];
